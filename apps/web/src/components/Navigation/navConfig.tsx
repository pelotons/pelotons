...
function RoutesIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}>
      <path
        strokeLinecap="round"
...
function LayoutsIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}>
      <path
        strokeLinecap="round"
...
export const NAV_SECTIONS: NavSection[] = [
  {
    ...
    label: 'Main',
    items: [
      { id: 'dashboard', label: 'Dashboard', path: '/', icon: DashboardIcon, exact: true },
  ...
  },
  {
    ...
    label: 'Help',
    items: [
      { id: 'docs', label: 'Documentation', path: '/docs', icon: DocsIcon },
    ],
  },
];
